...
const Entrada = () => {
    ...
    const onProductSelect = product => {
        setForm(f => ({
            ...f,
            producto: product.MSDesc.trim(), 
            codigoProducto: product.MSCodi, 
            lote: product.lote,
    ...
    return (
        <div className="page">
            ...
            <div className="btn-group flex-wrap">
                <Button label="Consulta" icon="pi pi-search" className=" btn-success" onClick={handleNew} />
